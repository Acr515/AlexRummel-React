...
const imports = {
    ...
    'color-study': require('./assets/color-study.png'),
    'stadium-graphics': require('./assets/stadium-graphics.jpg'),
    'scoreboard': require('./assets/scoreboard.jpg'),
    'logo-animation': require('./assets/logo-animation.gif'),
    'logo-animation-video': require('./assets/logo-animation-video.mp4'),
    'merchandise': require('./assets/merchandise.jpg'),
};
